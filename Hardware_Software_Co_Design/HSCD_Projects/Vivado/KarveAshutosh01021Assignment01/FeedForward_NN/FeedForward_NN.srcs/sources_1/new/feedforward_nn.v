...
module feedforward_nn(
    input signed [7:0] in1,  // 8-bit signed input 1
    input signed [7:0] in2,  // 8-bit signed input 2
    input signed [7:0] in3,  // 8-bit signed input 3
    input signed [7:0] in4,  // 8-bit signed input 4
    output reg signed [7:0] out1,  // 8-bit signed output 1
    output reg signed [7:0] out2   // 8-bit signed output 2
    );
